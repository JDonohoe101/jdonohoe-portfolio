export default function Contact() {
    return (
      <section
        id="contact"
        className="w-full py-24 px-6 bg-white/10 backdrop-blur-sm rounded-lg shadow-lg max-w-3xl mx-auto font-inter"
      >
        <h2 className="text-4xl font-bold mb-8 text-secondary text-center">CONTACT ME</h2>
